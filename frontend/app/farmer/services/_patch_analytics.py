with open('frontend/app/farmer/services/analyticsService.ts', 'r', encoding='utf-8') as f:
    content = f.read()

new_content = """import { FarmAnalyticsData } from '../types/analytics';
...
with open('frontend/app/farmer/services/analyticsService.ts', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("analyticsService updated")
